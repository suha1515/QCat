...
#define QCAT_INTERNAL_ASSERT_NO_MSG(type, check) QCAT_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", QCAT_STRINGFY_MACRO(check),  std::filesystem::path(__FILE__).filename().string(), __LINE__)
