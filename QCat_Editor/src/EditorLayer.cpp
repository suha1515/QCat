...
namespace QCat
{
	...
	void EditorLayer::OnAttach()
	{
		...
		fbSpec.Attachments = { {FramebufferUsage::Color,TextureType::Texture2D,TextureDataFormat::RGBA8},
							   {FramebufferUsage::Color,TextureType::Texture2D,TextureDataFormat::RED32_INTEGER},
